...
public class GraphViz {
     ...
     */
    private final static String cfgProp = "/Users/joker/eclipse-workspace/test/bin/MyJava/config.properties";
     ...
     */
    private static String TEMP_DIR = "/Users/joker/eclipse-workspace/test/";
    ...
    private byte[] get_img_stream(File dot, String type) {
        ...
        try {
            ...
            String[] args = { DOT, "-T" + type, "-Gdpi=" + dpiSizes[this.currentDpiPos], dot.getAbsolutePath(), "-o",
                    img.getAbsolutePath() };
    ...
    public static void createDotGraph(String dotFormat, String fileName) {
        ...
        gv.decreaseDpi();
        gv.decreaseDpi();
        File out = new File("/Users/joker/Desktop/" + fileName + "." + type);
        gv.writeGraphToFile(gv.getGraph(gv.getDotSource(), type), out);
    }
